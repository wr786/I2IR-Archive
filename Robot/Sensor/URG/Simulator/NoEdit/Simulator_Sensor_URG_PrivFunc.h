...
#ifndef SIMULATOR_SENSOR_URG_PRIVFUNC_H
#define SIMULATOR_SENSOR_URG_PRIVFUNC_H

#include<RobotSDK_Global.h>

/*! \defgroup Simulator_Sensor_URG_PrivFunc Simulator_Sensor_URG_PrivFunc
	\ingroup Simulator_Sensor_URG
	\brief Simulator_Sensor_URG_PrivFunc defines the PrivFunc in Simulator_Sensor_URG.
*/

/*! \addtogroup Simulator_Sensor_URG_PrivFunc
	@{
*/

/*! \file Simulator_Sensor_URG_PrivFunc.h
	 Defines the PrivFunc of Simulator_Sensor_URG
*/

//*******************Please add other headers below*******************


#include "../Edit/Simulator_Sensor_URG_Vars.h"
...
#undef NODECONFIG
#endif
#define NODECONFIG Simulator_Sensor_URG

/*! bool Simulator_Sensor_URG_setParamsVarsOpenNode(QString qstrConfigName, QString qstrNodeType, QString qstrNodeClass, QString qstrNodeName, void * paramsPtr, void * varsPtr)
...
/*! bool Simulator_Sensor_URG_handleVarsCloseNode(void * paramsPtr, void * varsPtr)
...
/*! void Simulator_Sensor_URG_getInternalTrigger(void * paramsPtr, void * varsPtr, QObject * & internalTrigger, QString & internalTriggerSignal)
...
/*! void Simulator_Sensor_URG_initializeOutputData(void * paramsPtr, void * varsPtr, boost::shared_ptr<void> & outputDataPtr)
...
/*! bool Simulator_Sensor_URG_generateSourceData(void * paramsPtr, void * varsPtr, void * outputData, QList<int> & outputPortIndex, QTime & timeStamp)
